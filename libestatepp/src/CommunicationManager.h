...
private:
	...
	void (*get_global_callback_func)(unsigned long id, const char* key) = NULL;
...
public:
	...
	virtual void register_get_global_callback(void (*cb_func)(unsigned long id, const char* key)) {this->get_global_callback_func = cb_func; }
};
